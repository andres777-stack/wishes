"""
Django settings for projectoBase project.
...
SECRET_KEY = 'django-insecure-aw&q9wnr^wlx+&e)sdoc=zwi*xdd372r4e4hz!15sx_fl=i(lo'
...
ROOT_URLCONF = 'projectoBase.urls'
...
WSGI_APPLICATION = 'projectoBase.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'meher2', # contraseña a la que la cambió al instalar Postgres
